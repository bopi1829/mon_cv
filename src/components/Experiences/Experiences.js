    ...
    return(
        <div className="Experiences">
            ...
            <p className="Experiences-p">
                Coder en React JS pour mettre en application la formation React JS Enterprise, utilisation de props, création de plusieurs composants, imbrication de composants. Mise en place des tests unitaires afin de montrer l'utilisation des Tests Unitaires. Présentation des différentes formations avec le détail de celles-ci et les différentes expériences professionnelles antérieures.
            </p>
